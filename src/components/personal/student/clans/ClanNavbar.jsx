...
const pages = [
  { key: "hq", label: "Clan HQ", icon: Home, path: "/personal/student/clans" },
  { key: "lb", label: "Leader Board", icon: Trophy, path: "/personal/student/clans/leaderboard" },
  { key: "members", label: "Members", icon: Users, path: "/personal/student/clans/members" },
  { key: "chat", label: "Chat", icon: MessageCircle, path: "/personal/student/clans/chat" },
];
