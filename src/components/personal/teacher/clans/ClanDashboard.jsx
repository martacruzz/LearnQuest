  ...
  return (
    <div className="ml-16 p-6 flex flex-col">
      ...
      <div className="flex gap-6">
        {/* Left Panel with Clan Avatar */}
        <div className="bg-gray-100 p-6 shield-effect clip-shield overflow-visible flex flex-col items-center">
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <div className="bg-gray-100 p-6 rounded-2xl shadow-sm">
            ...
            <div className="w-full bg-gray-300 rounded-full h-4 overflow-hidden mb-2">
              <div
                className={`bg-green-500 h-4 transition-all duration-1000 ease-out ${
                  xpPercentage === 100 ? "shadow-md shadow-green-400" : ""
                }`}
            ...
            <div className="text-gray-600 text-sm">Level: {level}</div>
          </div>
          ...
          {/* Exit Clan Button OUTSIDE the image div, centered below */}
          <div className="mt-6 w-full flex justify-left">
            <button className="px-4 py-2 bg-red-400 text-white font-semibold rounded-lg hover:bg-red-600 transition">
              Exit clan
            </button>
          </div>
    </div>
